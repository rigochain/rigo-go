...
func NewTrxProposal(from, to types.Address, nonce, gas uint64, gasPrice *uint256.Int, msg string, start, period, applyHeight int64, optType int32, options ...[]byte) *types2.Trx {
	return types2.NewTrx(
		uint32(1),
		from, to,
		nonce,
